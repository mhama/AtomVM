...
#define M5_ATOMS_BASE_INDEX (ODD_ATOM_INDEX + 1)
#define M5_SHOW_MESSAGE_ATOM_INDEX (M5_ATOMS_BASE_INDEX + 0)
#define M5_BUTTON_READ_ATOM_INDEX (M5_ATOMS_BASE_INDEX + 1)
...
// M5
#define M5_SHOW_MESSAGE_ATOM TERM_FROM_ATOM_INDEX(M5_SHOW_MESSAGE_ATOM_INDEX)
#define M5_BUTTON_READ_ATOM TERM_FROM_ATOM_INDEX(M5_BUTTON_READ_ATOM_INDEX)
